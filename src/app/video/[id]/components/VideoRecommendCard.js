...
export default function VideoRecommendCard({ videoEntity, isMobile }) {
    return (
        <div className="video-recommend-card">
            <div className="flex">
                <div className={`${isMobile ? 'w-[120px] h-[70px]' : 'w-[189px] h-[107px]'} mr-[10px] rounded-[7px] overflow-hidden`}>
